    ...
    function newContext(contextName) {
        ...
        Module.prototype = {
            ...
            enable: function () {
                ...
                //Enable each dependency  each depMap->value   i->attr
        ...
        context = {
            ...
            completeLoad: function (moduleName) {
                ...
                takeGlobalQueue();
                // defQueue  = {moduleName: name, deps: [], fn: fn}
                // 这里我有三个模块
                // module1 = {moduleName: null, deps: ['lodash'], fn}
                // jquery = {moduleName: 'jquery', deps:[], fn}
                // lodash = {moduleName: null, deps:[], fn}
                // 
                while (defQueue.length) {
                    args = defQueue.shift();
                    if (args[0] === null) {
        ...
        //第一次req()让context.require = context.makeRequire
        //第二次调用req(cfg)  //context.require返回值为context.require;
